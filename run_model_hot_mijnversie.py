...
from model_hot_mijnversie import FugitiveModel
...
if __name__ == '__main__':
    ...
    for city in ['Rotterdam']:
        for location in ['centre', 'port']:
            ...
            graph = ox.load_graphml(filepath=f"graphs/{city}_withtraffic_prepped_hot.graph.graphml")
            ...
            for jitter in [0.02]:
                ...
                #     AttributeError
                    ...
                    # import fug routes
                with open(f'data/escape_routes_{city}_{mode}_{location}_withtraffic.pkl', 'rb') as f:
