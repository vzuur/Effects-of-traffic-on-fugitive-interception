...
class Source(object):
    ...
    def create_entities(self, **kwargs):
        ...
        self.simulator.schedule_event_rel(relative_delay, self, "create_entities")  # TODO overschrijven in mijn source zodat er geen nieuwe entities gecreeerd worden
    ...
    def exit_output_node(self, entity, **kwargs):
        ...
        """
        logger.debug(f"Time {self.simulator.simulator_time:.2f}: Exit Source of {entity.name}")
        ...
        try:
            ...
            try:
                ...
                raise AttributeError(f"{self.name} has no next process assigned")
